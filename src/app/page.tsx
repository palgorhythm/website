...
const MUSIC_CARDS = [
  ...
  },
  {
    ...
    title: 'tours',
    tours: [
      { name: 'button masher US + canada', year: '2023', href: 'https://www.instagram.com/_buttonmasher/' },
      { name: 'angelica garcia US', year: '2021', href: 'https://www.instagram.com/angelicagarcia/' },
      { name: 'oliver tree US', year: '2018', href: 'https://www.instagram.com/olivertree/' },
      { name: 'standards US', year: '2018', href: 'https://www.instagram.com/wearestandards/' },
      { name: 'sélébéyone EU', year: '2017', href: 'https://www.instagram.com/thestevelehman/' },
      { name: 'battery US', year: '2016', href: 'https://www.instagram.com/_battery/' },
    ],
    icon: <Globe size={20} />,
  },
]
