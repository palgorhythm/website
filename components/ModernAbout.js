...
import { Code2, Briefcase, GraduationCap, Award, MapPin, ExternalLink } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
            I've been building software systems for over a decade while keeping busy as a musician. 
            Currently working at Discord on ads and creator tools.
          </p>
        </motion.div>
              ...
              {experience.map((job, index) => (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h4 className="text-lg font-semibold text-accent-primary">{job.role}</h4>
                      <div className="text-accent-secondary font-medium">{job.company}</div>
              ...
              <div className="space-y-4">
                <div className="glass rounded-xl p-6">
                  <div className="flex items-center mb-3">
                    ...
                    <span className="text-accent-secondary font-semibold">MFA</span>
                  </div>
                ...
                <div className="glass rounded-xl p-6">
                  <h4 className="text-lg font-semibold mb-2">New England Conservatory</h4>
                  <div className="text-text-secondary mb-1">
                ...
                <div className="glass rounded-xl p-6">
                  <div className="flex items-center mb-3">
                    <Award className="w-5 h-5 text-accent-secondary mr-2" />
                    <span className="text-accent-secondary font-semibold">Summa Cum Laude</span>
                  </div>
                  <h4 className="text-lg font-semibold mb-2">UC Berkeley</h4>
                  <div className="text-text-secondary mb-1">
                    Applied Mathematics & Music
                  </div>
                  <div className="text-text-muted text-sm">Bachelor's Degree</div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="glass rounded-2xl p-8 text-center">
            ...
            <h3 className="text-2xl font-semibold mb-4 gradient-text">Recognition</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-text-secondary">
              <div>
                <div className="text-accent-primary font-semibold mb-1">Patent Filed</div>
                <div className="text-sm">Financial platform tooling</div>
              </div>
              <div>
                <div className="text-accent-secondary font-semibold mb-1">6,130+ Network</div>
                <div className="text-sm">LinkedIn connections</div>
              </div>
              <div>
                <div className="text-accent-tertiary font-semibold mb-1">8.5k+ Followers</div>
