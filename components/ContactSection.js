...
import { Mail, Github, Linkedin, Instagram, Youtube, ExternalLink, Music } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Whether you're interested in collaborating on music, discussing technology, 
            or exploring new opportunities, I would love to hear from you.
          </p>
        </motion.div>
          ...
          {socialLinks.map((link, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`inline-flex p-3 rounded-lg bg-gradient-to-br ${link.color} mb-3 group-hover:scale-110 transition-transform duration-300`}>
                  {link.icon}
                </div>
        ...
        >
          <div className="text-gray-300 mb-4">
            Currently based in <span className="text-neon-cyan font-semibold">Los Angeles, CA</span>
          </div>
          <div className="text-gray-400 text-sm">
            Available for software engineering roles, music collaborations, and creative projects
          </div>
          <div className="mt-6 pt-6 border-t border-gray-700">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} Jacob Richards. Building the future through code and music.
            </p>
          </div>
        </motion.div>
      </div>
