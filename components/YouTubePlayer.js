...
import { Play, ExternalLink, Music, X, SkipForward, SkipBack, Pause } from 'lucide-react'
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-text-secondary">{currentTrackData.title}</div>
              </div>
            </div>
            <button
        ...
        <div className="glass rounded-2xl p-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-text-secondary">BATTERY • dial up</div>
              </div>
            </div>
            <button
              onClick={togglePlayer}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-xs text-text-muted">{currentTrack + 1}/{tracks.length}</span>
              <a
